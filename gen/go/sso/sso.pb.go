...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\x03R\x06userId\"-\n" +
	"\x10SetAdminResponse\x12\x19\n" +
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\xe6\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponse\x129\n" +
	"\bSetAdmin\x12\x15.auth.SetAdminRequest\x1a\x16.auth.SetAdminResponseB\x18Z\x16dexguitar.sso.v1;ssov1b\x06proto3"
